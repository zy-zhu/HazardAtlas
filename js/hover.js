var margin = {top: 20, right: 50, bottom: 30, left: 50},
    ...
    var svg = d3.select("#canvas02").append("svg")
    ...
    d3.csv("https://raw.githubusercontent.com/zy-zhu/Hazard_Atlas/master/volcano_eruption_info_details.csv", function(error, data) {
    ...
    function tweenDash() {
      ...
      return function (t) { return i(t); };
       ...
       var div = d3.select("#canvas02").append("div")	
      .attr("class", "tooltip")				
      .style("opacity", 0)
      .style("left","1000px");
    ...
    .enter().append("circle") // Uses the enter().append() method
      ...
      .on("mouseover", function(d) {		
          div.transition()		
              .duration(100)		
              .style("opacity", .9);		
          div.html("Volcano times: "+d.value + "<br/>"  + "Year: " + d.year)	
            .style("left",function() {console.log(d3.event.pageX); } + "px")		
